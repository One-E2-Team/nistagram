...
CREATE TABLE `host_summary` (`host` varchar(255), `statements` decimal(64,0), `statement_latency` varchar(11), `statement_avg_latency` varchar(11), `table_scans` decimal(65,0), `file_ios` decimal(64,0), `file_io_latency` varchar(11), `current_connections` decimal(41,0), `total_connections` decimal(41,0), `unique_users` bigint, `current_memory` varchar(11), `total_memory_allocated` varchar(11));


DROP VIEW IF EXISTS `host_summary_by_file_io`;
CREATE TABLE `host_summary_by_file_io` (`host` varchar(255), `ios` decimal(42,0), `io_latency` varchar(11));


DROP VIEW IF EXISTS `host_summary_by_file_io_type`;
CREATE TABLE `host_summary_by_file_io_type` (`host` varchar(255), `event_name` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `max_latency` varchar(11));


DROP VIEW IF EXISTS `host_summary_by_stages`;
CREATE TABLE `host_summary_by_stages` (`host` varchar(255), `event_name` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `avg_latency` varchar(11));


DROP VIEW IF EXISTS `host_summary_by_statement_latency`;
CREATE TABLE `host_summary_by_statement_latency` (`host` varchar(255), `total` decimal(42,0), `total_latency` varchar(11), `max_latency` varchar(11), `lock_latency` varchar(11), `rows_sent` decimal(42,0), `rows_examined` decimal(42,0), `rows_affected` decimal(42,0), `full_scans` decimal(43,0));


DROP VIEW IF EXISTS `host_summary_by_statement_type`;
CREATE TABLE `host_summary_by_statement_type` (`host` varchar(255), `statement` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `max_latency` varchar(11), `lock_latency` varchar(11), `rows_sent` bigint unsigned, `rows_examined` bigint unsigned, `rows_affected` bigint unsigned, `full_scans` bigint unsigned);


DROP VIEW IF EXISTS `innodb_buffer_stats_by_schema`;
CREATE TABLE `innodb_buffer_stats_by_schema` (`object_schema` text, `allocated` varchar(11), `data` varchar(11), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(45,0));


DROP VIEW IF EXISTS `innodb_buffer_stats_by_table`;
CREATE TABLE `innodb_buffer_stats_by_table` (`object_schema` text, `object_name` text, `allocated` varchar(11), `data` varchar(11), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(45,0));


DROP VIEW IF EXISTS `innodb_lock_waits`;
CREATE TABLE `innodb_lock_waits` (`wait_started` datetime, `wait_age` time, `wait_age_secs` bigint, `locked_table` mediumtext, `locked_table_schema` varchar(64), `locked_table_name` varchar(64), `locked_table_partition` varchar(64), `locked_table_subpartition` varchar(64), `locked_index` varchar(64), `locked_type` varchar(32), `waiting_trx_id` bigint unsigned, `waiting_trx_started` datetime, `waiting_trx_age` time, `waiting_trx_rows_locked` bigint unsigned, `waiting_trx_rows_modified` bigint unsigned, `waiting_pid` bigint unsigned, `waiting_query` longtext, `waiting_lock_id` varchar(128), `waiting_lock_mode` varchar(32), `blocking_trx_id` bigint unsigned, `blocking_pid` bigint unsigned, `blocking_query` longtext, `blocking_lock_id` varchar(128), `blocking_lock_mode` varchar(32), `blocking_trx_started` datetime, `blocking_trx_age` time, `blocking_trx_rows_locked` bigint unsigned, `blocking_trx_rows_modified` bigint unsigned, `sql_kill_blocking_query` varchar(33), `sql_kill_blocking_connection` varchar(27));


DROP VIEW IF EXISTS `io_by_thread_by_latency`;
CREATE TABLE `io_by_thread_by_latency` (`user` varchar(288), `total` decimal(42,0), `total_latency` varchar(11), `min_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11), `thread_id` bigint unsigned, `processlist_id` bigint unsigned);


DROP VIEW IF EXISTS `io_global_by_file_by_bytes`;
CREATE TABLE `io_global_by_file_by_bytes` (`file` varchar(512), `count_read` bigint unsigned, `total_read` varchar(11), `avg_read` varchar(11), `count_write` bigint unsigned, `total_written` varchar(11), `avg_write` varchar(11), `total` varchar(11), `write_pct` decimal(26,2));


DROP VIEW IF EXISTS `io_global_by_file_by_latency`;
CREATE TABLE `io_global_by_file_by_latency` (`file` varchar(512), `total` bigint unsigned, `total_latency` varchar(11), `count_read` bigint unsigned, `read_latency` varchar(11), `count_write` bigint unsigned, `write_latency` varchar(11), `count_misc` bigint unsigned, `misc_latency` varchar(11));


DROP VIEW IF EXISTS `io_global_by_wait_by_bytes`;
CREATE TABLE `io_global_by_wait_by_bytes` (`event_name` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `min_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11), `count_read` bigint unsigned, `total_read` varchar(11), `avg_read` varchar(11), `count_write` bigint unsigned, `total_written` varchar(11), `avg_written` varchar(11), `total_requested` varchar(11));


DROP VIEW IF EXISTS `io_global_by_wait_by_latency`;
CREATE TABLE `io_global_by_wait_by_latency` (`event_name` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11), `read_latency` varchar(11), `write_latency` varchar(11), `misc_latency` varchar(11), `count_read` bigint unsigned, `total_read` varchar(11), `avg_read` varchar(11), `count_write` bigint unsigned, `total_written` varchar(11), `avg_written` varchar(11));


DROP VIEW IF EXISTS `latest_file_io`;
CREATE TABLE `latest_file_io` (`thread` varchar(317), `file` varchar(512), `latency` varchar(11), `operation` varchar(32), `requested` varchar(11));


DROP VIEW IF EXISTS `memory_by_host_by_current_bytes`;
CREATE TABLE `memory_by_host_by_current_bytes` (`host` varchar(255), `current_count_used` decimal(41,0), `current_allocated` varchar(11), `current_avg_alloc` varchar(11), `current_max_alloc` varchar(11), `total_allocated` varchar(11));


DROP VIEW IF EXISTS `memory_by_thread_by_current_bytes`;
CREATE TABLE `memory_by_thread_by_current_bytes` (`thread_id` bigint unsigned, `user` varchar(288), `current_count_used` decimal(41,0), `current_allocated` varchar(11), `current_avg_alloc` varchar(11), `current_max_alloc` varchar(11), `total_allocated` varchar(11));


DROP VIEW IF EXISTS `memory_by_user_by_current_bytes`;
CREATE TABLE `memory_by_user_by_current_bytes` (`user` varchar(32), `current_count_used` decimal(41,0), `current_allocated` varchar(11), `current_avg_alloc` varchar(11), `current_max_alloc` varchar(11), `total_allocated` varchar(11));


DROP VIEW IF EXISTS `memory_global_by_current_bytes`;
CREATE TABLE `memory_global_by_current_bytes` (`event_name` varchar(128), `current_count` bigint, `current_alloc` varchar(11), `current_avg_alloc` varchar(11), `high_count` bigint, `high_alloc` varchar(11), `high_avg_alloc` varchar(11));


DROP VIEW IF EXISTS `memory_global_total`;
CREATE TABLE `memory_global_total` (`total_allocated` varchar(11));


DROP VIEW IF EXISTS `metrics`;
CREATE TABLE `metrics` (`Variable_name` varchar(193), `Variable_value` text, `Type` varchar(210), `Enabled` varchar(7));


DROP VIEW IF EXISTS `processlist`;
CREATE TABLE `processlist` (`thd_id` bigint unsigned, `conn_id` bigint unsigned, `user` varchar(288), `db` varchar(64), `command` varchar(16), `state` varchar(64), `time` bigint, `current_statement` longtext, `statement_latency` varchar(11), `progress` decimal(26,2), `lock_latency` varchar(11), `rows_examined` bigint unsigned, `rows_sent` bigint unsigned, `rows_affected` bigint unsigned, `tmp_tables` bigint unsigned, `tmp_disk_tables` bigint unsigned, `full_scan` varchar(3), `last_statement` longtext, `last_statement_latency` varchar(11), `current_memory` varchar(11), `last_wait` varchar(128), `last_wait_latency` varchar(13), `source` varchar(64), `trx_latency` varchar(11), `trx_state` enum('ACTIVE','COMMITTED','ROLLED BACK'), `trx_autocommit` enum('YES','NO'), `pid` varchar(1024), `program_name` varchar(1024));


DROP VIEW IF EXISTS `ps_check_lost_instrumentation`;
CREATE TABLE `ps_check_lost_instrumentation` (`variable_name` varchar(64), `variable_value` varchar(1024));


DROP VIEW IF EXISTS `schema_auto_increment_columns`;
CREATE TABLE `schema_auto_increment_columns` (`table_schema` varchar(64), `table_name` varchar(64), `column_name` varchar(64), `data_type` longtext, `column_type` mediumtext, `is_signed` int, `is_unsigned` int, `max_value` bigint unsigned, `auto_increment` bigint unsigned, `auto_increment_ratio` decimal(25,4) unsigned);


DROP VIEW IF EXISTS `schema_index_statistics`;
CREATE TABLE `schema_index_statistics` (`table_schema` varchar(64), `table_name` varchar(64), `index_name` varchar(64), `rows_selected` bigint unsigned, `select_latency` varchar(11), `rows_inserted` bigint unsigned, `insert_latency` varchar(11), `rows_updated` bigint unsigned, `update_latency` varchar(11), `rows_deleted` bigint unsigned, `delete_latency` varchar(11));


DROP VIEW IF EXISTS `schema_object_overview`;
CREATE TABLE `schema_object_overview` (`db` varchar(64), `object_type` varchar(19), `count` bigint);


DROP VIEW IF EXISTS `schema_redundant_indexes`;
CREATE TABLE `schema_redundant_indexes` (`table_schema` varchar(64), `table_name` varchar(64), `redundant_index_name` varchar(64), `redundant_index_columns` text, `redundant_index_non_unique` int, `dominant_index_name` varchar(64), `dominant_index_columns` text, `dominant_index_non_unique` int, `subpart_exists` int, `sql_drop_index` varchar(223));


DROP VIEW IF EXISTS `schema_table_lock_waits`;
CREATE TABLE `schema_table_lock_waits` (`object_schema` varchar(64), `object_name` varchar(64), `waiting_thread_id` bigint unsigned, `waiting_pid` bigint unsigned, `waiting_account` text, `waiting_lock_type` varchar(32), `waiting_lock_duration` varchar(32), `waiting_query` longtext, `waiting_query_secs` bigint, `waiting_query_rows_affected` bigint unsigned, `waiting_query_rows_examined` bigint unsigned, `blocking_thread_id` bigint unsigned, `blocking_pid` bigint unsigned, `blocking_account` text, `blocking_lock_type` varchar(32), `blocking_lock_duration` varchar(32), `sql_kill_blocking_query` varchar(31), `sql_kill_blocking_connection` varchar(25));


DROP VIEW IF EXISTS `schema_table_statistics`;
CREATE TABLE `schema_table_statistics` (`table_schema` varchar(64), `table_name` varchar(64), `total_latency` varchar(11), `rows_fetched` bigint unsigned, `fetch_latency` varchar(11), `rows_inserted` bigint unsigned, `insert_latency` varchar(11), `rows_updated` bigint unsigned, `update_latency` varchar(11), `rows_deleted` bigint unsigned, `delete_latency` varchar(11), `io_read_requests` decimal(42,0), `io_read` varchar(11), `io_read_latency` varchar(11), `io_write_requests` decimal(42,0), `io_write` varchar(11), `io_write_latency` varchar(11), `io_misc_requests` decimal(42,0), `io_misc_latency` varchar(11));


DROP VIEW IF EXISTS `schema_table_statistics_with_buffer`;
CREATE TABLE `schema_table_statistics_with_buffer` (`table_schema` varchar(64), `table_name` varchar(64), `rows_fetched` bigint unsigned, `fetch_latency` varchar(11), `rows_inserted` bigint unsigned, `insert_latency` varchar(11), `rows_updated` bigint unsigned, `update_latency` varchar(11), `rows_deleted` bigint unsigned, `delete_latency` varchar(11), `io_read_requests` decimal(42,0), `io_read` varchar(11), `io_read_latency` varchar(11), `io_write_requests` decimal(42,0), `io_write` varchar(11), `io_write_latency` varchar(11), `io_misc_requests` decimal(42,0), `io_misc_latency` varchar(11), `innodb_buffer_allocated` varchar(11), `innodb_buffer_data` varchar(11), `innodb_buffer_free` varchar(11), `innodb_buffer_pages` bigint, `innodb_buffer_pages_hashed` bigint, `innodb_buffer_pages_old` bigint, `innodb_buffer_rows_cached` decimal(45,0));


DROP VIEW IF EXISTS `schema_tables_with_full_table_scans`;
CREATE TABLE `schema_tables_with_full_table_scans` (`object_schema` varchar(64), `object_name` varchar(64), `rows_full_scanned` bigint unsigned, `latency` varchar(11));


DROP VIEW IF EXISTS `schema_unused_indexes`;
CREATE TABLE `schema_unused_indexes` (`object_schema` varchar(64), `object_name` varchar(64), `index_name` varchar(64));


DROP VIEW IF EXISTS `session`;
CREATE TABLE `session` (`thd_id` bigint unsigned, `conn_id` bigint unsigned, `user` varchar(288), `db` varchar(64), `command` varchar(16), `state` varchar(64), `time` bigint, `current_statement` longtext, `statement_latency` varchar(11), `progress` decimal(26,2), `lock_latency` varchar(11), `rows_examined` bigint unsigned, `rows_sent` bigint unsigned, `rows_affected` bigint unsigned, `tmp_tables` bigint unsigned, `tmp_disk_tables` bigint unsigned, `full_scan` varchar(3), `last_statement` longtext, `last_statement_latency` varchar(11), `current_memory` varchar(11), `last_wait` varchar(128), `last_wait_latency` varchar(13), `source` varchar(64), `trx_latency` varchar(11), `trx_state` enum('ACTIVE','COMMITTED','ROLLED BACK'), `trx_autocommit` enum('YES','NO'), `pid` varchar(1024), `program_name` varchar(1024));


DROP VIEW IF EXISTS `session_ssl_status`;
CREATE TABLE `session_ssl_status` (`thread_id` bigint unsigned, `ssl_version` varchar(1024), `ssl_cipher` varchar(1024), `ssl_sessions_reused` varchar(1024));


DROP VIEW IF EXISTS `statement_analysis`;
CREATE TABLE `statement_analysis` (`query` longtext, `db` varchar(64), `full_scan` varchar(1), `exec_count` bigint unsigned, `err_count` bigint unsigned, `warn_count` bigint unsigned, `total_latency` varchar(11), `max_latency` varchar(11), `avg_latency` varchar(11), `lock_latency` varchar(11), `rows_sent` bigint unsigned, `rows_sent_avg` decimal(21,0), `rows_examined` bigint unsigned, `rows_examined_avg` decimal(21,0), `rows_affected` bigint unsigned, `rows_affected_avg` decimal(21,0), `tmp_tables` bigint unsigned, `tmp_disk_tables` bigint unsigned, `rows_sorted` bigint unsigned, `sort_merge_passes` bigint unsigned, `digest` varchar(64), `first_seen` timestamp(6), `last_seen` timestamp(6));


DROP VIEW IF EXISTS `statements_with_errors_or_warnings`;
CREATE TABLE `statements_with_errors_or_warnings` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `errors` bigint unsigned, `error_pct` decimal(27,4), `warnings` bigint unsigned, `warning_pct` decimal(27,4), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `statements_with_full_table_scans`;
CREATE TABLE `statements_with_full_table_scans` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `total_latency` varchar(11), `no_index_used_count` bigint unsigned, `no_good_index_used_count` bigint unsigned, `no_index_used_pct` decimal(24,0), `rows_sent` bigint unsigned, `rows_examined` bigint unsigned, `rows_sent_avg` decimal(21,0), `rows_examined_avg` decimal(21,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `statements_with_runtimes_in_95th_percentile`;
CREATE TABLE `statements_with_runtimes_in_95th_percentile` (`query` longtext, `db` varchar(64), `full_scan` varchar(1), `exec_count` bigint unsigned, `err_count` bigint unsigned, `warn_count` bigint unsigned, `total_latency` varchar(11), `max_latency` varchar(11), `avg_latency` varchar(11), `rows_sent` bigint unsigned, `rows_sent_avg` decimal(21,0), `rows_examined` bigint unsigned, `rows_examined_avg` decimal(21,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `statements_with_sorting`;
CREATE TABLE `statements_with_sorting` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `total_latency` varchar(11), `sort_merge_passes` bigint unsigned, `avg_sort_merges` decimal(21,0), `sorts_using_scans` bigint unsigned, `sort_using_range` bigint unsigned, `rows_sorted` bigint unsigned, `avg_rows_sorted` decimal(21,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `statements_with_temp_tables`;
CREATE TABLE `statements_with_temp_tables` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `total_latency` varchar(11), `memory_tmp_tables` bigint unsigned, `disk_tmp_tables` bigint unsigned, `avg_tmp_tables_per_query` decimal(21,0), `tmp_tables_to_disk_pct` decimal(24,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));
...
('diagnostics.allow_i_s_tables',	'OFF',	'2021-07-09 14:03:15',	NULL),
('diagnostics.include_raw',	'OFF',	'2021-07-09 14:03:15',	NULL),
('ps_thread_trx_info.max_length',	'65535',	'2021-07-09 14:03:15',	NULL),
('statement_performance_analyzer.limit',	'100',	'2021-07-09 14:03:15',	NULL),
('statement_performance_analyzer.view',	NULL,	'2021-07-09 14:03:15',	NULL),
('statement_truncate_len',	'64',	'2021-07-09 14:03:15',	NULL);
...
CREATE TABLE `user_summary` (`user` varchar(32), `statements` decimal(64,0), `statement_latency` varchar(11), `statement_avg_latency` varchar(11), `table_scans` decimal(65,0), `file_ios` decimal(64,0), `file_io_latency` varchar(11), `current_connections` decimal(41,0), `total_connections` decimal(41,0), `unique_hosts` bigint, `current_memory` varchar(11), `total_memory_allocated` varchar(11));


DROP VIEW IF EXISTS `user_summary_by_file_io`;
CREATE TABLE `user_summary_by_file_io` (`user` varchar(32), `ios` decimal(42,0), `io_latency` varchar(11));


DROP VIEW IF EXISTS `user_summary_by_file_io_type`;
CREATE TABLE `user_summary_by_file_io_type` (`user` varchar(32), `event_name` varchar(128), `total` bigint unsigned, `latency` varchar(11), `max_latency` varchar(11));


DROP VIEW IF EXISTS `user_summary_by_stages`;
CREATE TABLE `user_summary_by_stages` (`user` varchar(32), `event_name` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `avg_latency` varchar(11));


DROP VIEW IF EXISTS `user_summary_by_statement_latency`;
CREATE TABLE `user_summary_by_statement_latency` (`user` varchar(32), `total` decimal(42,0), `total_latency` varchar(11), `max_latency` varchar(11), `lock_latency` varchar(11), `rows_sent` decimal(42,0), `rows_examined` decimal(42,0), `rows_affected` decimal(42,0), `full_scans` decimal(43,0));


DROP VIEW IF EXISTS `user_summary_by_statement_type`;
CREATE TABLE `user_summary_by_statement_type` (`user` varchar(32), `statement` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `max_latency` varchar(11), `lock_latency` varchar(11), `rows_sent` bigint unsigned, `rows_examined` bigint unsigned, `rows_affected` bigint unsigned, `full_scans` bigint unsigned);


DROP VIEW IF EXISTS `version`;
CREATE TABLE `version` (`sys_version` varchar(5), `mysql_version` varchar(6));


DROP VIEW IF EXISTS `wait_classes_global_by_avg_latency`;
CREATE TABLE `wait_classes_global_by_avg_latency` (`event_class` varchar(128), `total` decimal(42,0), `total_latency` varchar(11), `min_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11));


DROP VIEW IF EXISTS `wait_classes_global_by_latency`;
CREATE TABLE `wait_classes_global_by_latency` (`event_class` varchar(128), `total` decimal(42,0), `total_latency` varchar(11), `min_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11));


DROP VIEW IF EXISTS `waits_by_host_by_latency`;
CREATE TABLE `waits_by_host_by_latency` (`host` varchar(255), `event` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11));


DROP VIEW IF EXISTS `waits_by_user_by_latency`;
CREATE TABLE `waits_by_user_by_latency` (`user` varchar(32), `event` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11));


DROP VIEW IF EXISTS `waits_global_by_latency`;
CREATE TABLE `waits_global_by_latency` (`events` varchar(128), `total` bigint unsigned, `total_latency` varchar(11), `avg_latency` varchar(11), `max_latency` varchar(11));


DROP VIEW IF EXISTS `x$host_summary`;
CREATE TABLE `x$host_summary` (`host` varchar(255), `statements` decimal(64,0), `statement_latency` decimal(64,0), `statement_avg_latency` decimal(65,4), `table_scans` decimal(65,0), `file_ios` decimal(64,0), `file_io_latency` decimal(64,0), `current_connections` decimal(41,0), `total_connections` decimal(41,0), `unique_users` bigint, `current_memory` decimal(63,0), `total_memory_allocated` decimal(64,0));


DROP VIEW IF EXISTS `x$host_summary_by_file_io`;
CREATE TABLE `x$host_summary_by_file_io` (`host` varchar(255), `ios` decimal(42,0), `io_latency` decimal(42,0));


DROP VIEW IF EXISTS `x$host_summary_by_file_io_type`;
CREATE TABLE `x$host_summary_by_file_io_type` (`host` varchar(255), `event_name` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `max_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$host_summary_by_stages`;
CREATE TABLE `x$host_summary_by_stages` (`host` varchar(255), `event_name` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `avg_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$host_summary_by_statement_latency`;
CREATE TABLE `x$host_summary_by_statement_latency` (`host` varchar(255), `total` decimal(42,0), `total_latency` decimal(42,0), `max_latency` bigint unsigned, `lock_latency` decimal(42,0), `rows_sent` decimal(42,0), `rows_examined` decimal(42,0), `rows_affected` decimal(42,0), `full_scans` decimal(43,0));


DROP VIEW IF EXISTS `x$host_summary_by_statement_type`;
CREATE TABLE `x$host_summary_by_statement_type` (`host` varchar(255), `statement` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `max_latency` bigint unsigned, `lock_latency` bigint unsigned, `rows_sent` bigint unsigned, `rows_examined` bigint unsigned, `rows_affected` bigint unsigned, `full_scans` bigint unsigned);


DROP VIEW IF EXISTS `x$innodb_buffer_stats_by_schema`;
CREATE TABLE `x$innodb_buffer_stats_by_schema` (`object_schema` text, `allocated` decimal(44,0), `data` decimal(44,0), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(45,0));


DROP VIEW IF EXISTS `x$innodb_buffer_stats_by_table`;
CREATE TABLE `x$innodb_buffer_stats_by_table` (`object_schema` text, `object_name` text, `allocated` decimal(44,0), `data` decimal(44,0), `pages` bigint, `pages_hashed` bigint, `pages_old` bigint, `rows_cached` decimal(45,0));


DROP VIEW IF EXISTS `x$innodb_lock_waits`;
CREATE TABLE `x$innodb_lock_waits` (`wait_started` datetime, `wait_age` time, `wait_age_secs` bigint, `locked_table` mediumtext, `locked_table_schema` varchar(64), `locked_table_name` varchar(64), `locked_table_partition` varchar(64), `locked_table_subpartition` varchar(64), `locked_index` varchar(64), `locked_type` varchar(32), `waiting_trx_id` bigint unsigned, `waiting_trx_started` datetime, `waiting_trx_age` time, `waiting_trx_rows_locked` bigint unsigned, `waiting_trx_rows_modified` bigint unsigned, `waiting_pid` bigint unsigned, `waiting_query` varchar(1024), `waiting_lock_id` varchar(128), `waiting_lock_mode` varchar(32), `blocking_trx_id` bigint unsigned, `blocking_pid` bigint unsigned, `blocking_query` varchar(1024), `blocking_lock_id` varchar(128), `blocking_lock_mode` varchar(32), `blocking_trx_started` datetime, `blocking_trx_age` time, `blocking_trx_rows_locked` bigint unsigned, `blocking_trx_rows_modified` bigint unsigned, `sql_kill_blocking_query` varchar(33), `sql_kill_blocking_connection` varchar(27));


DROP VIEW IF EXISTS `x$io_by_thread_by_latency`;
CREATE TABLE `x$io_by_thread_by_latency` (`user` varchar(288), `total` decimal(42,0), `total_latency` decimal(42,0), `min_latency` bigint unsigned, `avg_latency` decimal(24,4), `max_latency` bigint unsigned, `thread_id` bigint unsigned, `processlist_id` bigint unsigned);


DROP VIEW IF EXISTS `x$io_global_by_file_by_bytes`;
CREATE TABLE `x$io_global_by_file_by_bytes` (`file` varchar(512), `count_read` bigint unsigned, `total_read` bigint, `avg_read` decimal(23,4), `count_write` bigint unsigned, `total_written` bigint, `avg_write` decimal(23,4), `total` bigint, `write_pct` decimal(26,2));


DROP VIEW IF EXISTS `x$io_global_by_file_by_latency`;
CREATE TABLE `x$io_global_by_file_by_latency` (`file` varchar(512), `total` bigint unsigned, `total_latency` bigint unsigned, `count_read` bigint unsigned, `read_latency` bigint unsigned, `count_write` bigint unsigned, `write_latency` bigint unsigned, `count_misc` bigint unsigned, `misc_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$io_global_by_wait_by_bytes`;
CREATE TABLE `x$io_global_by_wait_by_bytes` (`event_name` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `min_latency` bigint unsigned, `avg_latency` bigint unsigned, `max_latency` bigint unsigned, `count_read` bigint unsigned, `total_read` bigint, `avg_read` decimal(23,4), `count_write` bigint unsigned, `total_written` bigint, `avg_written` decimal(23,4), `total_requested` bigint);


DROP VIEW IF EXISTS `x$io_global_by_wait_by_latency`;
CREATE TABLE `x$io_global_by_wait_by_latency` (`event_name` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `avg_latency` bigint unsigned, `max_latency` bigint unsigned, `read_latency` bigint unsigned, `write_latency` bigint unsigned, `misc_latency` bigint unsigned, `count_read` bigint unsigned, `total_read` bigint, `avg_read` decimal(23,4), `count_write` bigint unsigned, `total_written` bigint, `avg_written` decimal(23,4));


DROP VIEW IF EXISTS `x$latest_file_io`;
CREATE TABLE `x$latest_file_io` (`thread` varchar(317), `file` varchar(512), `latency` bigint unsigned, `operation` varchar(32), `requested` bigint);


DROP VIEW IF EXISTS `x$memory_by_host_by_current_bytes`;
CREATE TABLE `x$memory_by_host_by_current_bytes` (`host` varchar(255), `current_count_used` decimal(41,0), `current_allocated` decimal(41,0), `current_avg_alloc` decimal(45,4), `current_max_alloc` bigint, `total_allocated` decimal(42,0));


DROP VIEW IF EXISTS `x$memory_by_thread_by_current_bytes`;
CREATE TABLE `x$memory_by_thread_by_current_bytes` (`thread_id` bigint unsigned, `user` varchar(288), `current_count_used` decimal(41,0), `current_allocated` decimal(41,0), `current_avg_alloc` decimal(45,4), `current_max_alloc` bigint, `total_allocated` decimal(42,0));


DROP VIEW IF EXISTS `x$memory_by_user_by_current_bytes`;
CREATE TABLE `x$memory_by_user_by_current_bytes` (`user` varchar(32), `current_count_used` decimal(41,0), `current_allocated` decimal(41,0), `current_avg_alloc` decimal(45,4), `current_max_alloc` bigint, `total_allocated` decimal(42,0));


DROP VIEW IF EXISTS `x$memory_global_by_current_bytes`;
CREATE TABLE `x$memory_global_by_current_bytes` (`event_name` varchar(128), `current_count` bigint, `current_alloc` bigint, `current_avg_alloc` decimal(23,4), `high_count` bigint, `high_alloc` bigint, `high_avg_alloc` decimal(23,4));


DROP VIEW IF EXISTS `x$memory_global_total`;
CREATE TABLE `x$memory_global_total` (`total_allocated` decimal(41,0));


DROP VIEW IF EXISTS `x$processlist`;
CREATE TABLE `x$processlist` (`thd_id` bigint unsigned, `conn_id` bigint unsigned, `user` varchar(288), `db` varchar(64), `command` varchar(16), `state` varchar(64), `time` bigint, `current_statement` longtext, `statement_latency` bigint unsigned, `progress` decimal(26,2), `lock_latency` bigint unsigned, `rows_examined` bigint unsigned, `rows_sent` bigint unsigned, `rows_affected` bigint unsigned, `tmp_tables` bigint unsigned, `tmp_disk_tables` bigint unsigned, `full_scan` varchar(3), `last_statement` longtext, `last_statement_latency` bigint unsigned, `current_memory` decimal(41,0), `last_wait` varchar(128), `last_wait_latency` varchar(20), `source` varchar(64), `trx_latency` bigint unsigned, `trx_state` enum('ACTIVE','COMMITTED','ROLLED BACK'), `trx_autocommit` enum('YES','NO'), `pid` varchar(1024), `program_name` varchar(1024));


DROP VIEW IF EXISTS `x$ps_digest_95th_percentile_by_avg_us`;
CREATE TABLE `x$ps_digest_95th_percentile_by_avg_us` (`avg_us` decimal(21,0), `percentile` decimal(46,4));


DROP VIEW IF EXISTS `x$ps_digest_avg_latency_distribution`;
CREATE TABLE `x$ps_digest_avg_latency_distribution` (`cnt` bigint, `avg_us` decimal(21,0));


DROP VIEW IF EXISTS `x$ps_schema_table_statistics_io`;
CREATE TABLE `x$ps_schema_table_statistics_io` (`table_schema` varchar(64), `table_name` varchar(64), `count_read` decimal(42,0), `sum_number_of_bytes_read` decimal(41,0), `sum_timer_read` decimal(42,0), `count_write` decimal(42,0), `sum_number_of_bytes_write` decimal(41,0), `sum_timer_write` decimal(42,0), `count_misc` decimal(42,0), `sum_timer_misc` decimal(42,0));


DROP VIEW IF EXISTS `x$schema_flattened_keys`;
CREATE TABLE `x$schema_flattened_keys` (`table_schema` varchar(64), `table_name` varchar(64), `index_name` varchar(64), `non_unique` int, `subpart_exists` bigint, `index_columns` text);


DROP VIEW IF EXISTS `x$schema_index_statistics`;
CREATE TABLE `x$schema_index_statistics` (`table_schema` varchar(64), `table_name` varchar(64), `index_name` varchar(64), `rows_selected` bigint unsigned, `select_latency` bigint unsigned, `rows_inserted` bigint unsigned, `insert_latency` bigint unsigned, `rows_updated` bigint unsigned, `update_latency` bigint unsigned, `rows_deleted` bigint unsigned, `delete_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$schema_table_lock_waits`;
CREATE TABLE `x$schema_table_lock_waits` (`object_schema` varchar(64), `object_name` varchar(64), `waiting_thread_id` bigint unsigned, `waiting_pid` bigint unsigned, `waiting_account` text, `waiting_lock_type` varchar(32), `waiting_lock_duration` varchar(32), `waiting_query` longtext, `waiting_query_secs` bigint, `waiting_query_rows_affected` bigint unsigned, `waiting_query_rows_examined` bigint unsigned, `blocking_thread_id` bigint unsigned, `blocking_pid` bigint unsigned, `blocking_account` text, `blocking_lock_type` varchar(32), `blocking_lock_duration` varchar(32), `sql_kill_blocking_query` varchar(31), `sql_kill_blocking_connection` varchar(25));


DROP VIEW IF EXISTS `x$schema_table_statistics`;
CREATE TABLE `x$schema_table_statistics` (`table_schema` varchar(64), `table_name` varchar(64), `total_latency` bigint unsigned, `rows_fetched` bigint unsigned, `fetch_latency` bigint unsigned, `rows_inserted` bigint unsigned, `insert_latency` bigint unsigned, `rows_updated` bigint unsigned, `update_latency` bigint unsigned, `rows_deleted` bigint unsigned, `delete_latency` bigint unsigned, `io_read_requests` decimal(42,0), `io_read` decimal(41,0), `io_read_latency` decimal(42,0), `io_write_requests` decimal(42,0), `io_write` decimal(41,0), `io_write_latency` decimal(42,0), `io_misc_requests` decimal(42,0), `io_misc_latency` decimal(42,0));


DROP VIEW IF EXISTS `x$schema_table_statistics_with_buffer`;
CREATE TABLE `x$schema_table_statistics_with_buffer` (`table_schema` varchar(64), `table_name` varchar(64), `rows_fetched` bigint unsigned, `fetch_latency` bigint unsigned, `rows_inserted` bigint unsigned, `insert_latency` bigint unsigned, `rows_updated` bigint unsigned, `update_latency` bigint unsigned, `rows_deleted` bigint unsigned, `delete_latency` bigint unsigned, `io_read_requests` decimal(42,0), `io_read` decimal(41,0), `io_read_latency` decimal(42,0), `io_write_requests` decimal(42,0), `io_write` decimal(41,0), `io_write_latency` decimal(42,0), `io_misc_requests` decimal(42,0), `io_misc_latency` decimal(42,0), `innodb_buffer_allocated` decimal(44,0), `innodb_buffer_data` decimal(44,0), `innodb_buffer_free` decimal(45,0), `innodb_buffer_pages` bigint, `innodb_buffer_pages_hashed` bigint, `innodb_buffer_pages_old` bigint, `innodb_buffer_rows_cached` decimal(45,0));


DROP VIEW IF EXISTS `x$schema_tables_with_full_table_scans`;
CREATE TABLE `x$schema_tables_with_full_table_scans` (`object_schema` varchar(64), `object_name` varchar(64), `rows_full_scanned` bigint unsigned, `latency` bigint unsigned);


DROP VIEW IF EXISTS `x$session`;
CREATE TABLE `x$session` (`thd_id` bigint unsigned, `conn_id` bigint unsigned, `user` varchar(288), `db` varchar(64), `command` varchar(16), `state` varchar(64), `time` bigint, `current_statement` longtext, `statement_latency` bigint unsigned, `progress` decimal(26,2), `lock_latency` bigint unsigned, `rows_examined` bigint unsigned, `rows_sent` bigint unsigned, `rows_affected` bigint unsigned, `tmp_tables` bigint unsigned, `tmp_disk_tables` bigint unsigned, `full_scan` varchar(3), `last_statement` longtext, `last_statement_latency` bigint unsigned, `current_memory` decimal(41,0), `last_wait` varchar(128), `last_wait_latency` varchar(20), `source` varchar(64), `trx_latency` bigint unsigned, `trx_state` enum('ACTIVE','COMMITTED','ROLLED BACK'), `trx_autocommit` enum('YES','NO'), `pid` varchar(1024), `program_name` varchar(1024));


DROP VIEW IF EXISTS `x$statement_analysis`;
CREATE TABLE `x$statement_analysis` (`query` longtext, `db` varchar(64), `full_scan` varchar(1), `exec_count` bigint unsigned, `err_count` bigint unsigned, `warn_count` bigint unsigned, `total_latency` bigint unsigned, `max_latency` bigint unsigned, `avg_latency` bigint unsigned, `lock_latency` bigint unsigned, `rows_sent` bigint unsigned, `rows_sent_avg` decimal(21,0), `rows_examined` bigint unsigned, `rows_examined_avg` decimal(21,0), `rows_affected` bigint unsigned, `rows_affected_avg` decimal(21,0), `tmp_tables` bigint unsigned, `tmp_disk_tables` bigint unsigned, `rows_sorted` bigint unsigned, `sort_merge_passes` bigint unsigned, `digest` varchar(64), `first_seen` timestamp(6), `last_seen` timestamp(6));


DROP VIEW IF EXISTS `x$statements_with_errors_or_warnings`;
CREATE TABLE `x$statements_with_errors_or_warnings` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `errors` bigint unsigned, `error_pct` decimal(27,4), `warnings` bigint unsigned, `warning_pct` decimal(27,4), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `x$statements_with_full_table_scans`;
CREATE TABLE `x$statements_with_full_table_scans` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `total_latency` bigint unsigned, `no_index_used_count` bigint unsigned, `no_good_index_used_count` bigint unsigned, `no_index_used_pct` decimal(24,0), `rows_sent` bigint unsigned, `rows_examined` bigint unsigned, `rows_sent_avg` decimal(21,0), `rows_examined_avg` decimal(21,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `x$statements_with_runtimes_in_95th_percentile`;
CREATE TABLE `x$statements_with_runtimes_in_95th_percentile` (`query` longtext, `db` varchar(64), `full_scan` varchar(1), `exec_count` bigint unsigned, `err_count` bigint unsigned, `warn_count` bigint unsigned, `total_latency` bigint unsigned, `max_latency` bigint unsigned, `avg_latency` bigint unsigned, `rows_sent` bigint unsigned, `rows_sent_avg` decimal(21,0), `rows_examined` bigint unsigned, `rows_examined_avg` decimal(21,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `x$statements_with_sorting`;
CREATE TABLE `x$statements_with_sorting` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `total_latency` bigint unsigned, `sort_merge_passes` bigint unsigned, `avg_sort_merges` decimal(21,0), `sorts_using_scans` bigint unsigned, `sort_using_range` bigint unsigned, `rows_sorted` bigint unsigned, `avg_rows_sorted` decimal(21,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `x$statements_with_temp_tables`;
CREATE TABLE `x$statements_with_temp_tables` (`query` longtext, `db` varchar(64), `exec_count` bigint unsigned, `total_latency` bigint unsigned, `memory_tmp_tables` bigint unsigned, `disk_tmp_tables` bigint unsigned, `avg_tmp_tables_per_query` decimal(21,0), `tmp_tables_to_disk_pct` decimal(24,0), `first_seen` timestamp(6), `last_seen` timestamp(6), `digest` varchar(64));


DROP VIEW IF EXISTS `x$user_summary`;
CREATE TABLE `x$user_summary` (`user` varchar(32), `statements` decimal(64,0), `statement_latency` decimal(64,0), `statement_avg_latency` decimal(65,4), `table_scans` decimal(65,0), `file_ios` decimal(64,0), `file_io_latency` decimal(64,0), `current_connections` decimal(41,0), `total_connections` decimal(41,0), `unique_hosts` bigint, `current_memory` decimal(63,0), `total_memory_allocated` decimal(64,0));


DROP VIEW IF EXISTS `x$user_summary_by_file_io`;
CREATE TABLE `x$user_summary_by_file_io` (`user` varchar(32), `ios` decimal(42,0), `io_latency` decimal(42,0));


DROP VIEW IF EXISTS `x$user_summary_by_file_io_type`;
CREATE TABLE `x$user_summary_by_file_io_type` (`user` varchar(32), `event_name` varchar(128), `total` bigint unsigned, `latency` bigint unsigned, `max_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$user_summary_by_stages`;
CREATE TABLE `x$user_summary_by_stages` (`user` varchar(32), `event_name` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `avg_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$user_summary_by_statement_latency`;
CREATE TABLE `x$user_summary_by_statement_latency` (`user` varchar(32), `total` decimal(42,0), `total_latency` decimal(42,0), `max_latency` decimal(42,0), `lock_latency` decimal(42,0), `rows_sent` decimal(42,0), `rows_examined` decimal(42,0), `rows_affected` decimal(42,0), `full_scans` decimal(43,0));


DROP VIEW IF EXISTS `x$user_summary_by_statement_type`;
CREATE TABLE `x$user_summary_by_statement_type` (`user` varchar(32), `statement` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `max_latency` bigint unsigned, `lock_latency` bigint unsigned, `rows_sent` bigint unsigned, `rows_examined` bigint unsigned, `rows_affected` bigint unsigned, `full_scans` bigint unsigned);


DROP VIEW IF EXISTS `x$wait_classes_global_by_avg_latency`;
CREATE TABLE `x$wait_classes_global_by_avg_latency` (`event_class` varchar(128), `total` decimal(42,0), `total_latency` decimal(42,0), `min_latency` bigint unsigned, `avg_latency` decimal(46,4), `max_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$wait_classes_global_by_latency`;
CREATE TABLE `x$wait_classes_global_by_latency` (`event_class` varchar(128), `total` decimal(42,0), `total_latency` decimal(42,0), `min_latency` bigint unsigned, `avg_latency` decimal(46,4), `max_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$waits_by_host_by_latency`;
CREATE TABLE `x$waits_by_host_by_latency` (`host` varchar(255), `event` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `avg_latency` bigint unsigned, `max_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$waits_by_user_by_latency`;
CREATE TABLE `x$waits_by_user_by_latency` (`user` varchar(32), `event` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `avg_latency` bigint unsigned, `max_latency` bigint unsigned);


DROP VIEW IF EXISTS `x$waits_global_by_latency`;
CREATE TABLE `x$waits_global_by_latency` (`events` varchar(128), `total` bigint unsigned, `total_latency` bigint unsigned, `avg_latency` bigint unsigned, `max_latency` bigint unsigned);
...
CREATE ALGORITHM=TEMPTABLE DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `memory_global_total` (`total_allocated`) AS select format_bytes(sum(`performance_schema`.`memory_summary_global_by_event_name`.`CURRENT_NUMBER_OF_BYTES_USED`)) AS `total_allocated` from `performance_schema`.`memory_summary_global_by_event_name`;
